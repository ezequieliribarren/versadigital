...
<div className='imgRubro'>
    <img src="/images/centroDeEstetica/sitioPresentacion.webp" alt="Sitio web" />
</div>
<div className='descripRubro2'>
    <div>
          <p>Creamos el sitio de presentación ideal para tu centro, 100% personalizado y adaptado a tus necesidades</p> 
    </div>
...
<div className='imgRubro'>
    <img src="/images/centroDeEstetica/turnos.webp" alt="Turnos" />
</div>
<div className='descripRubro2'>
    <div>
...
<div className='imgRubro'>
    <img src="/images/centroDeEstetica/blog.webp" alt="Blog" />
</div>
<div className='descripRubro2'>
    <div>
          <p>Suma un blog en tu sitio para construir relaciones más fuertes con tus clientes, compartiendo información relevantec</p> 
    </div>
...
export default CentrosDeEstetica