...
<div className='imgRubro'>
    <img src="/images/eventos/maskEventos.webp" alt="Imagen de marca" />
</div>
<div className='descripRubro'>
   <p>Destacá, genera confianza y lealtad con una imagen de marca profesional para tu espacio</p> 
</div>
</div>
...
<div className='imgRubro'>
    <img src="/images/eventos/sitioPresentacion.webp" alt="Sitio de Presentación" />
</div>
...
<div className='imgRubro'>
    <img src="/images/eventos/turnos.webp" alt="Turnos" />
</div>
<div className='descripRubro2'>
    <div>
